...
const UbahPasswordAdmin = () => {
    ...
    return (
        <Layout>
            <Breadcrumb pageName='Formulaire de changement de mot de passe' />

            <div className='sm:grid-cols-2'>
                <div className='flex flex-col gap-9'>
                    <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
                        <div className='border-b border-stroke py-4 px-6.5 dark:border-strokedark'>
                            <h3 className='font-medium text-black dark:text-white'>Formulaire de changement de mot de passe</h3>
                        </div>
                                ...
                                <div className='mb-4.5 '>
                                    <div className='w-full mb-4'>
                                        <label className='mb-4 block text-black dark:text-white'>
                                            Nouveau mot de passe <span className='text-meta-1'>*</span>
                                        </label>
                                        <input
                                            type='password'
                                            value={password}
                                    ...
                                    <div className='w-full mb-4'>
                                        <label className='mb-4 block text-black dark:text-white'>
                                            Confirmez le nouveau mot de passe <span className='text-meta-1'>*</span>
                                        </label>
                                        <input
                                            type='password'
